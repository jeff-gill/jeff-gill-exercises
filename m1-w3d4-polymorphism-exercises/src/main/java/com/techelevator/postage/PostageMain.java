...
public class PostageMain {
	...
	public static void main(String[] args) {
		...
		System.out.print("--------------------------------------");
		System.out.println();
		System.out.format("%1s%7s%1s\n", "Postal Service (1st Class)", "$", (new PostalService("1st Class").BigDecimal(calculateRate(BigDecimal)distanceTraveling), weightAmount)));
		...
		System.out.format("%1s%28s%1s\n", "FexEd", "$", (((IDeliveryDriver) new BigDecimal(20)).calculateRate(distanceTraveling, weightAmount)));
