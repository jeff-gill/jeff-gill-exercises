	...
	<table>
		<tr>
			...
			<c:forEach var="product" items="${productList}">
				<td><a
					href="<c:url value="productDetail?productId=${product.productId}"/> "><img style="width: 8em"
						src="img/${product.imageName}"></a></td>
		...
		<tr id="left-column">
			<td>Name</td>
			<c:forEach var="product" items="${productList}">
				<td id="product-name" style="background-color: lightgray"
					align="center"><a
		...
		<tr id="product-mfg">
			...
			<c:forEach var="product" items="${productList}">
				<td style="background-color: lightgray" align="center">by
					${product.manufacturer}</td>
			</c:forEach>
		</tr>
		<tr>
		...
		<tr>
			...
			<c:forEach var="product" items="${productList}">
				<td id="product-weight" style="background-color: lightgray"
					align="center">${product.weightInLbs}lbs</td>
			</c:forEach>
		</tr>
	</table>
</section>
