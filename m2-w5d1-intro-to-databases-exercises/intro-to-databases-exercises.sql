...
-- 13. Thce name of all cities in the USA with a population between 1 million and 2 million people (6 rows) 
...
SELECT ((gnp * 1000000) / population) AS percapitagnp FROM country
WHERE continent = 'Europe'


-- 22. The number of years since independence for all countries that have a year of independence (192 rows)

SELECT (2018 - indepyear) AS numberyearssinceindependence FROM country
